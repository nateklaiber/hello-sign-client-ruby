...
* `bin/rake routes` will show all available route definitions
* `bin/rake signature_requests` will list out a subset of signature requests

### YARD
All code is document with Yard. You can use this with:

* `yard`: This will generate the documentation
* `yard server`: This will start the yard server and enable documentation in the browser
