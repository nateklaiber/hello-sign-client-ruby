...
module HelloSign
  class Connection < SimpleDelegator
    ...
    #
    # @example
    #   connection = HelloSign::Connection.new(url: 'http://example.com') do |conn|
    #     conn.adapter(HelloSign::Connection.default_adapter)
    #   end
    #
    #   @connection.headers['Authorization'] = "Bearer 1234"
    #
    # @return [HelloSign::Connection] Faraday Connection Delegator
